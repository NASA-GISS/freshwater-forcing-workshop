...
- [[#introduction][Introduction]]
  - [[#data-example][Data example]]
    - [[#minimum-discharge-depth-per-roi][Minimum discharge depth per ROI]]
    - [[#plot-of-annual-discharge-summed-for-all-of-greenland][Plot of annual discharge summed for all of Greenland]]
    - [[#plot-of-monthly-discharge-by-roi][Plot of monthly discharge by ROI]]
...
*** Minimum discharge depth per ROI
...
*** Plot of annual discharge summed for all of Greenland
...
*** Plot of monthly discharge by ROI
...
_ = axs[0].set_ylabel('Discharge [Gt month$^{-1}$]')
#+END_SRC
